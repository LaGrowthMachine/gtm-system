...
| Wrong person who names the right one | Not nurture: a referral. Ask who the right contact is (reply-draft-assistant), then a new campaign for that person. |
...
| `already_sent[]` | thread + attributes | every URL already shared with this lead |
